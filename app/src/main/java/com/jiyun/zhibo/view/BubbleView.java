...
public class BubbleView extends RelativeLayout {
    ...
    public void startAnimation(final float rankWidth, final float rankHeight, int count) {
    ...
    private void bubbleAnimation(float rankWidth, float rankHeight) {
    ...
    private ValueAnimator getBesselAnimator(final ImageView imageView, float rankWidth, float rankHeight) {
